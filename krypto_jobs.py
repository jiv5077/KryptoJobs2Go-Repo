...
def main():
    ...
    st.sidebar.write("Client Account Address and Ethereum Balance in Ether")

    # Debug statement to print account object structure
    st.sidebar.write(f"Account: {account}")

    try:
        st.sidebar.write("Account Address:", account.address)
    except AttributeError:
        st.sidebar.write("Account object does not have an 'address' attribute")
